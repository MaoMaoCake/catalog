## About Cloudnative PGPlugin Barman Cloud

The Cloudnative PG Plugin Barman Cloud is a plugin for CloudNative PG that enables enables online continuous physical
...
CloudNativePG is a trademark of the Linux Foundation. All rights in the mark are reserved to the Linux Foundation. Any
use by Docker is for referential purposes only and does not indicate sponsorship, endorsement, or affiliation. This
